...
/**
 * Registers a counter method
 *
 * Registers a method to be used for the Countable interface if this collection
 * is a relation.
 *
 ...
 *
 * Be advised that this method results in the lazy-load being run - but _only_
 * if this is not a relation-collection of a has_many or HABTM relation type.
 * In that case the collection will not be loaded by this method.
 *
 * The has_many / HABTM counter method is saved in the Collection::$counter
 * property, and is generated by ModelBase::load_relations() and uses
 * Collection::register_counter().
 *
